...
//Overflow 예외 클래스
class OverflowException extends RuntimeException { // 교재 553 java제공 class
...
//    }
	...
	public void printBooks(String li) {
		System.out.println(li);
		for (Book bk : books) {
			if (bk == null) {
				System.out.println("출력할 도서 없음");
				break;
			}
			else System.out.println(bk.toString());
		}
	}

	public void removeBook() {
		if (top <= 0) {
			System.out.println("삭제 할 도서 없음");
